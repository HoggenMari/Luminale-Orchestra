...
public class Breath2 {
	...
	public Breath2(PApplet p, Pavillon scp, ColorFadeList cfList, int hue, int saturation, int startSpeed){
		this.p = p;
		this.scp = scp;
		this.cfList = cfList;
		this.hue = hue;
		...
		c1.brightnessFade(0, startSpeed, 2);
		c2.brightnessFade(30, startSpeed, 2);
		c3.brightnessFade(40, startSpeed, 2);
		c4.brightnessFade(50, startSpeed, 2);
		c5.brightnessFade(55, startSpeed, 2);
	...
	public void draw(int speedBreath){
		...
		if(c1.isDead()){
			...
			c1.brightnessFade(0, speedBreath, 2);
			c2.brightnessFade(30, speedBreath, 2);
			c3.brightnessFade(40, speedBreath, 2);
			c4.brightnessFade(50, speedBreath, 2);
